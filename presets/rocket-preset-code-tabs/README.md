...
| ------------------------------ | -------------------------- | ------------------------------ |
| --code-button-background       | `transparent`              | button background              |
...
| --code-button-background             | `transparent`              | tab button background                  |
| --code-button-color                  | `inherit`                  | tab button text color                  |
...
| tabpanel          | container for content     |
| tab               | tab button                |
...
| Name                           | Default                    | Description                         |
| ------------------------------ | -------------------------- | ----------------------------------- |
| --code-button-background       | `transparent`              | copy button background              |
| --code-button-color            | `inherit`                  | copy button text color              |
